...
class MainWindow : JFrame() {
    ...
    init {
        ...
        pointData.addElement(Vertex(-15.0, 0.0, 15.0))
        pointData.addElement(Vertex(-15.0, 5.0, 5.0))
        pointData.addElement(Vertex(-15.0, 5.0, -5.0))
        pointData.addElement(Vertex(-15.0, 0.0, -15.0))

        pointData.addElement(Vertex(-5.0, 5.0, 15.0))
        pointData.addElement(Vertex(-5.0, 5.0, 5.0))
        pointData.addElement(Vertex(-5.0, 5.0, -5.0))
        pointData.addElement(Vertex(-5.0, 5.0, -15.0))
